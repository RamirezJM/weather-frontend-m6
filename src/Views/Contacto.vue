    ...
    <div class="contacto__form w-100 mx-auto">
      ...
      >
        ...
        <input
          ...
          type="text"
          placeholder="Nombre"
          class="form-control border-primary w-100 my-3"
          :class="{ 'is-invalid': form.nombre && !nombreValido }"
        >
        <div v-if="form.nombre && !nombreValido"
        ...
        >
        <div v-if="form.email && !emailValido"
             class="invalid-feedback text-center">
        ...
        <textarea
          ...
          placeholder="Mensaje"
          class="form-control border-primary w-100 my-3"
          :class="{ 'is-invalid': form.mensaje && !mensajeValido }"
        ></textarea>
        <div v-if="form.mensaje && !mensajeValido"
             class="invalid-feedback text-center">
        ...
        <!-- Botón -->
        <button
          class="btn form__btn form__btn--lg text-uppercase fw-semibold d-block mx-auto mt-3"
          type="submit"
